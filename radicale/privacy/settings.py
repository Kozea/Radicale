...
class PrivacySettings:
    ...
    def set_settings(self, identifier: str, private_fields: List[str],
                    allowed_fields: Optional[List[str]] = None) -> bool:
        ...
        if allowed_fields is not None:
            ...
            if overlap:
                raise ValueError(f"Fields cannot be both private and allowed: {overlap}")
        else:
