...
class TestPrivacyDataset(unittest.TestCase):
    ...
    def test_vcf_files_exist(self):
        ...
        for filename in expected_files:
            ...
            self.assertTrue(
                os.path.exists(filepath), f"VCF file {filename} does not exist"
            )
            ...
            if filename.endswith(".vcf"):
                ...
                with open(filepath, "r") as f:
                    ...
                    try:
                        ...
                        self.assertTrue(
                            any(True for _ in vcards),
                            f"No valid vCard found in {filename}",
                        )
    ...
    def test_privacy_settings_exist(self):
        ...
        self.assertTrue(
            os.path.exists(settings_file), "Privacy settings file does not exist"
        )
